$(document).ready(function renderInnerJs(){
    $('#js-tab').eq(0).click(function(){
        $('#js-tab').eq(0).addClass("active")
        $('#css-tab').eq(0).removeClass("active")
        $('#html-tab').eq(0).removeClass("active")
        $('#comment-tab').eq(0).removeClass("active")
        $('#css-content').eq(0).removeClass('d-block')
        $('#html-content').eq(0).removeClass('d-block')
        $('#comment-content').eq(0).removeClass('d-block')
        $('#js-content').eq(0).removeClass('d-none')
        $('#js-content').eq(0).addClass('d-block')
        $('#js-content').eq(0).html(`
...
$(document).ready(function renderInnerHtml(){
    $('#html-tab').eq(0).click(function(){
        $('#html-tab').eq(0).addClass("active")
        $('#js-tab').eq(0).removeClass("active")
        $('#css-tab').eq(0).removeClass("active")
        $('#comment-tab').eq(0).removeClass("active")
        $('#js-content').eq(0).removeClass('d-block')
        $('#css-content').eq(0).removeClass('d-block')
        $('#comment-content').eq(0).removeClass('d-block')
        $('#html-content').eq(0).removeClass('d-none')
        $('#html-content').eq(0).addClass('d-block')
        $('#html-content').eq(0).html(`<p>
...
$(document).ready(function renderInnerCss(){
    $('#css-tab').eq(0).click(function(){
        $('#css-tab').eq(0).addClass("active")
        $('#js-tab').eq(0).removeClass("active")
        $('#html-tab').eq(0).removeClass("active")
        $('#comment-tab').eq(0).removeClass("active")
        $('#js-content').eq(0).removeClass('d-block')
        $('#html-content').eq(0).removeClass('d-block')
        $('#comment-content').eq(0).removeClass('d-block')
        $('#css-content').eq(0).removeClass('d-none')
        $('#css-content').eq(0).addClass('d-block')
        $('#css-content').eq(0).html(`
...
$(document).ready(function renderInnerComment(){
    $('#comment-tab').eq(0).click(function(){
        $('#comment-tab').eq(0).addClass("active")
        $('#js-tab').eq(0).removeClass("active")
        $('#html-tab').eq(0).removeClass("active")
        $('#css-tab').eq(0).removeClass("active")
        $('#js-content').eq(0).removeClass('d-block')
        $('#html-content').eq(0).removeClass('d-block')
        $('#css-content').eq(0).removeClass('d-block')
        $('#comment-content').eq(0).removeClass('d-none')
        $('#comment-content').eq(0).addClass('d-block')
        $('#comment-content').eq(0).html(`
        No comments posted for this page yet. Be the first to contribute!
        <div class="comment-add">
            <h3>Post new comment</h3>
            <p>
                Contributions in the form of tips, code snippets and suggestions for the above material are very welcome. 
                To post a comment, please use the form below. Text is formatted by 
                <a href="">Markdown</a>.
            </p>
            <p>
                To post comments, pleaes sign in to your DataTables account, or register:
            </p>
            <p></p>
            <ul class="formatting">
                <li>
                    <a href="https://datatables.net/forums/entry/signin?Target=https%3A%2F%2Fwww.datatables.net%2Fexamples%2Fbasic_init%2Fzero_configuration.html" 
                    target="_blank">Sign in</a>
                </li>
                <li>
                    <a href="https://datatables.net/forums/entry/register?Target=https%3A%2F%2Fwww.datatables.net%2Fexamples%2Fbasic_init%2Fzero_configuration.html"
                    target="_blank">Register</a>
                </li>
            </ul>
            <p>
                <b>Any questions poster here will be deleted without being published.</b>
                <br>
                Please post questions in the <a href="https://www.datatables.net/forums/" 
                target="_blank">Forums</a>. Comments are moderated.
            </p>
        </div>
        `)
    });
